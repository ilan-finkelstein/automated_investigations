...
def lambda_handler(event, context):
    ...
    payload = {'text': 'testing shit from main'}
    post_message(webhook, payload, x,y,z, ip)
    
    return {
        f"The IP is": ip, "Is this Barracuda": x, "Is this Org Cloud?": y, "Is this ISP Cloud?": z
    }
